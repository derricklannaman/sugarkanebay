...
class DestinationsController < ApplicationController
  ...
  def music_immersive; end

  def points_of_interest_immersive; end

  def culture_immersive; end

  def foods_immersive; end

  def art_immersive; end

  def political_immersive; end

  def geography_immersive; end
